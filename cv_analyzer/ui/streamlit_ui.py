...
def mostrar_resultados(resultado: AnalisisCV):
    ...
    educacion = getattr(resultado, "educacion", None) or getattr(resultado, "education", "No especificada")
    ...
    with col1:
        ...
        st.info(f"**⏱️ Experiencia:** {resultado.experiencia_anos} años")

    with col2:
        st.info(f"**🎓 Educación:** {educacion}")
